...
extension CustomPickerView :UIPickerViewDelegate{
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return self.datasource?.values()?[row] as? String
    
    }
    
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        selection = self.datasource?.values()?[row] as? String
...
extension CustomPickerView :UIPickerViewDataSource {
    ...
    func numberOfComponents(in pickerView: UIPickerView) -> Int {
        guard self.datasource?.values() != nil else {return 0}
         return 1
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return self.datasource?.values()?.count ?? 0
